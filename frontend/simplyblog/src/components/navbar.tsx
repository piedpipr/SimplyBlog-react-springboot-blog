...
import { faAddressBook, faGear, faSearch } from '@fortawesome/free-solid-svg-icons'
  ...
  <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
    ...
    <div className="lg:flex flex-grow items-center" id="example-navbar-warning">
      <ul className="flex flex-col lg:flex-row list-none mr-auto">
        ...
        <li className="nav-item">
         <NavLink to="navigation" className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75">
          <FontAwesomeIcon icon={ faAddressBook }/> <span className="ml-2">Add Post</span>
          </NavLink>
        </li>
        <li className="nav-item">
        <NavLink to="navigation" className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75">
